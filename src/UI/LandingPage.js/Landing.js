        ...
        <div>
          <div class="grid lg:grid-cols-3 p-8 gap-8">
            {data.map((item, key) => {
              return (
                <div
                  className=" p-2 hover:scale-110 ease-in duration-500 shadow-m rounded-lg bg-cardbackground"
                  key={item?.id}
                >
                  <div className=" flex justify-center align-middle lg:flex lg:max-w-lg rounded-lg">
                    <img
                      src={item.image}
                      className="rounded-lg w-1/1 lg:w-1/2 p-2"
                    />
                  </div>
                  <div className="mt-2">
                    ...
                    <p className="mt-1 text-3xl font-bold font-heading text-textcolor">
                      {item.description}
                    </p>
                    <div className="flex justify-between p-4 items-center">
                      <span className="mt-3 font-bold text-lg  text-textcolor">
                        {item.price}$
                      </span>
                      {item.alreadAdded ? (
                        <div className="flex flex-row justify-evenly items-center min-w-[50%] ">
                          <div
                        ...
                        <button
                          ...
                          className="font-bold border-solid border-textcolor border-2	p-2 bg-textcolor text-cardbackground"
                        >
                          Add to cart
                        </button>
                      )}
